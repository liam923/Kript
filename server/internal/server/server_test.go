...
//go:generate mockgen -destination mocks_test.go -package server_test github.com/liam923/Kript/server/proto UserService_ListUsersServer,UserService_ListUsersByRoleServer
