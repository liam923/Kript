...
type TwoFactorType int32

const (
	TwoFactorType_UNKNOWN_TWO_FACTOR_TYPE TwoFactorType = 0
	// A code via text message. This method is not yet supported.
	TwoFactorType_PHONE_TEXT TwoFactorType = 1
	// A code via phone call.
	TwoFactorType_PHONE_CALL TwoFactorType = 2
	// A code via email. This method is not yet supported.
	TwoFactorType_EMAIL TwoFactorType = 3
)

var TwoFactorType_name = map[int32]string{
	0: "UNKNOWN_TWO_FACTOR_TYPE",
	1: "PHONE_TEXT",
	2: "PHONE_CALL",
	3: "EMAIL",
}

var TwoFactorType_value = map[string]int32{
...
func (x TwoFactorType) String() string {
	return proto.EnumName(TwoFactorType_name, int32(x))
}

func (TwoFactorType) EnumDescriptor() ([]byte, []int) {
...
func (m *PublicUser) GetPasswordSalt() []byte {
	if m != nil {
...
type PrivateUser struct {
	...
	PrivateKeyIv []byte `protobuf:"bytes,3,opt,name=private_key_iv,json=privateKeyIv,proto3" json:"private_key_iv,omitempty"`
	// The salt used in generating the key for encrypting/decrypting the private key.
	PrivateKeyKeySalt []byte `protobuf:"bytes,4,opt,name=private_key_key_salt,json=privateKeyKeySalt,proto3" json:"private_key_key_salt,omitempty"`
	// The hash algorithm used to generate the key for encrypting/decrypting the private key.
	PrivateKeyKeyHashAlgorithm HashAlgorithm `protobuf:"varint,5,opt,name=private_key_key_hash_algorithm,json=privateKeyKeyHashAlgorithm,proto3,enum=kript.api.HashAlgorithm" json:"private_key_key_hash_algorithm,omitempty"`
	XXX_NoUnkeyedLiteral       struct{}      `json:"-"`
	XXX_unrecognized           []byte        `json:"-"`
	XXX_sizecache              int32         `json:"-"`
}
...
func (m *PrivateUser) GetPrivateKeyIv() []byte {
	if m != nil {
...
func (m *PrivateUser) GetPrivateKeyKeySalt() []byte {
	if m != nil {
		return m.PrivateKeyKeySalt
	}
	return nil
}

func (m *PrivateUser) GetPrivateKeyKeyHashAlgorithm() HashAlgorithm {
	if m != nil {
		return m.PrivateKeyKeyHashAlgorithm
	}
	return HashAlgorithm_UNKNOWN_HASH_ALGORITHM
}
...
type TwoFactor struct {
	...
	Type TwoFactorType `protobuf:"varint,1,opt,name=type,proto3,enum=kript.api.TwoFactorType" json:"type,omitempty"`
...
func (m *TwoFactor) GetType() TwoFactorType {
	if m != nil {
		return m.Type
	}
	return TwoFactorType_UNKNOWN_TWO_FACTOR_TYPE
}
...
type LoginUserResponse_TwoFactorInfo struct {
	...
	// id of the option.
	Options              map[string]*TwoFactor `protobuf:"bytes,2,rep,name=options,proto3" json:"options,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *LoginUserResponse_TwoFactorInfo) GetOptions() map[string]*TwoFactor {
	if m != nil {
		return m.Options
	}
	return nil
...
type SendVerificationRequest struct {
	...
	TwoFactorOptionId    string   `protobuf:"bytes,2,opt,name=two_factor_option_id,json=twoFactorOptionId,proto3" json:"two_factor_option_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SendVerificationRequest) GetTwoFactorOptionId() string {
	if m != nil {
		return m.TwoFactorOptionId
	}
	return ""
}
...
type UpdatePasswordRequest struct {
	...
	// The initialization vector used to encrypt the private key.
	PrivateKeyIv []byte `protobuf:"bytes,8,opt,name=private_key_iv,json=privateKeyIv,proto3" json:"private_key_iv,omitempty"`
	// The new salt used in generating the key for encrypting/decrypting the private key.
	PrivateKeyKeySalt []byte `protobuf:"bytes,9,opt,name=private_key_key_salt,json=privateKeyKeySalt,proto3" json:"private_key_key_salt,omitempty"`
	// The new hash algorithm used to generate the key for encrypting/decrypting the private key.
	PrivateKeyKeyHashAlgorithm HashAlgorithm `protobuf:"varint,10,opt,name=private_key_key_hash_algorithm,json=privateKeyKeyHashAlgorithm,proto3,enum=kript.api.HashAlgorithm" json:"private_key_key_hash_algorithm,omitempty"`
	XXX_NoUnkeyedLiteral       struct{}      `json:"-"`
	XXX_unrecognized           []byte        `json:"-"`
	XXX_sizecache              int32         `json:"-"`
}
...
func (m *UpdatePasswordRequest) GetNewSalt() []byte {
	if m != nil {
		return m.NewSalt
	}
	return nil
...
func (m *UpdatePasswordRequest) GetPrivateKeyIv() []byte {
	if m != nil {
		return m.PrivateKeyIv
	}
	return nil
...
func (m *UpdatePasswordRequest) GetPrivateKeyKeySalt() []byte {
	if m != nil {
		return m.PrivateKeyKeySalt
	}
	return nil
...
func (m *UpdatePasswordRequest) GetPrivateKeyKeyHashAlgorithm() HashAlgorithm {
	if m != nil {
		return m.PrivateKeyKeyHashAlgorithm
	}
	return HashAlgorithm_UNKNOWN_HASH_ALGORITHM
...
type CreateAccountRequest struct {
	...
	// The initialization vector used to encrypt the private key.
	PrivateKeyIv []byte `protobuf:"bytes,9,opt,name=private_key_iv,json=privateKeyIv,proto3" json:"private_key_iv,omitempty"`
	// The salt used in generating the key for encrypting/decrypting the private key.
	PrivateKeyKeySalt []byte `protobuf:"bytes,10,opt,name=private_key_key_salt,json=privateKeyKeySalt,proto3" json:"private_key_key_salt,omitempty"`
	// The hash algorithm used to generate the key for encrypting/decrypting the private key.
	PrivateKeyKeyHashAlgorithm HashAlgorithm `protobuf:"varint,11,opt,name=private_key_key_hash_algorithm,json=privateKeyKeyHashAlgorithm,proto3,enum=kript.api.HashAlgorithm" json:"private_key_key_hash_algorithm,omitempty"`
	XXX_NoUnkeyedLiteral       struct{}      `json:"-"`
	XXX_unrecognized           []byte        `json:"-"`
	XXX_sizecache              int32         `json:"-"`
}
...
func (m *CreateAccountRequest) GetSalt() []byte {
	if m != nil {
		return m.Salt
	}
	return nil
...
func (m *CreateAccountRequest) GetPrivateKeyIv() []byte {
	if m != nil {
		return m.PrivateKeyIv
	}
	return nil
...
func (m *CreateAccountRequest) GetPrivateKeyKeySalt() []byte {
	if m != nil {
		return m.PrivateKeyKeySalt
	}
	return nil
...
func (m *CreateAccountRequest) GetPrivateKeyKeyHashAlgorithm() HashAlgorithm {
	if m != nil {
		return m.PrivateKeyKeyHashAlgorithm
	}
	return HashAlgorithm_UNKNOWN_HASH_ALGORITHM
...
type AddTwoFactorRequest struct {
	// The access token to identify and authenticate the user.
	AccessToken *AccessToken `protobuf:"bytes,1,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"`
	// The two-factor authentication method to add.
	TwoFactor            *TwoFactor `protobuf:"bytes,2,opt,name=two_factor,json=twoFactor,proto3" json:"two_factor,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}

func (m *AddTwoFactorRequest) Reset()         { *m = AddTwoFactorRequest{} }
func (m *AddTwoFactorRequest) String() string { return proto.CompactTextString(m) }
func (*AddTwoFactorRequest) ProtoMessage()    {}
func (*AddTwoFactorRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_574df43e36ddeef5, []int{21}
}
func (m *AddTwoFactorRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AddTwoFactorRequest.Unmarshal(m, b)
}
func (m *AddTwoFactorRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AddTwoFactorRequest.Marshal(b, m, deterministic)
}
func (m *AddTwoFactorRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddTwoFactorRequest.Merge(m, src)
}
func (m *AddTwoFactorRequest) XXX_Size() int {
	return xxx_messageInfo_AddTwoFactorRequest.Size(m)
}
func (m *AddTwoFactorRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_AddTwoFactorRequest.DiscardUnknown(m)
}

var xxx_messageInfo_AddTwoFactorRequest proto.InternalMessageInfo

func (m *AddTwoFactorRequest) GetAccessToken() *AccessToken {
	if m != nil {
		return m.AccessToken
	}
	return nil
...
func (m *AddTwoFactorRequest) GetTwoFactor() *TwoFactor {
	if m != nil {
		return m.TwoFactor
	}
	return nil
...
type AddTwoFactorResponse struct {
	// The token used to identify the user through the verification process.
	VerificationToken    *VerificationToken `protobuf:"bytes,1,opt,name=verification_token,json=verificationToken,proto3" json:"verification_token,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
...
func (m *AddTwoFactorResponse) Reset()         { *m = AddTwoFactorResponse{} }
func (m *AddTwoFactorResponse) String() string { return proto.CompactTextString(m) }
func (*AddTwoFactorResponse) ProtoMessage()    {}
func (*AddTwoFactorResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_574df43e36ddeef5, []int{22}
}
func (m *AddTwoFactorResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AddTwoFactorResponse.Unmarshal(m, b)
}
func (m *AddTwoFactorResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AddTwoFactorResponse.Marshal(b, m, deterministic)
}
func (m *AddTwoFactorResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddTwoFactorResponse.Merge(m, src)
}
func (m *AddTwoFactorResponse) XXX_Size() int {
	return xxx_messageInfo_AddTwoFactorResponse.Size(m)
}
func (m *AddTwoFactorResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_AddTwoFactorResponse.DiscardUnknown(m)
}

var xxx_messageInfo_AddTwoFactorResponse proto.InternalMessageInfo

func (m *AddTwoFactorResponse) GetVerificationToken() *VerificationToken {
	if m != nil {
		return m.VerificationToken
	}
	return nil
...
type VerifyTwoFactorRequest struct {
	// The token used to identify the user through the verification process.
	VerificationToken *AccessToken `protobuf:"bytes,1,opt,name=verification_token,json=verificationToken,proto3" json:"verification_token,omitempty"`
	// The two-factor authentication code received on the specified destination.
	Code                 string   `protobuf:"bytes,2,opt,name=code,proto3" json:"code,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
func (m *VerifyTwoFactorRequest) Reset()         { *m = VerifyTwoFactorRequest{} }
func (m *VerifyTwoFactorRequest) String() string { return proto.CompactTextString(m) }
func (*VerifyTwoFactorRequest) ProtoMessage()    {}
func (*VerifyTwoFactorRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_574df43e36ddeef5, []int{23}
}
func (m *VerifyTwoFactorRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_VerifyTwoFactorRequest.Unmarshal(m, b)
}
func (m *VerifyTwoFactorRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_VerifyTwoFactorRequest.Marshal(b, m, deterministic)
}
func (m *VerifyTwoFactorRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VerifyTwoFactorRequest.Merge(m, src)
}
func (m *VerifyTwoFactorRequest) XXX_Size() int {
	return xxx_messageInfo_VerifyTwoFactorRequest.Size(m)
}
func (m *VerifyTwoFactorRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_VerifyTwoFactorRequest.DiscardUnknown(m)
}

var xxx_messageInfo_VerifyTwoFactorRequest proto.InternalMessageInfo

func (m *VerifyTwoFactorRequest) GetVerificationToken() *AccessToken {
	if m != nil {
		return m.VerificationToken
	}
	return nil
...
func (m *VerifyTwoFactorRequest) GetCode() string {
	if m != nil {
		return m.Code
	}
	return ""
...
type VerifyTwoFactorResponse struct {
	...
	TwoFactor            *TwoFactor `protobuf:"bytes,1,opt,name=two_factor,json=twoFactor,proto3" json:"two_factor,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}

func (m *VerifyTwoFactorResponse) Reset()         { *m = VerifyTwoFactorResponse{} }
func (m *VerifyTwoFactorResponse) String() string { return proto.CompactTextString(m) }
func (*VerifyTwoFactorResponse) ProtoMessage()    {}
func (*VerifyTwoFactorResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_574df43e36ddeef5, []int{24}
}
func (m *VerifyTwoFactorResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_VerifyTwoFactorResponse.Unmarshal(m, b)
}
func (m *VerifyTwoFactorResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_VerifyTwoFactorResponse.Marshal(b, m, deterministic)
}
func (m *VerifyTwoFactorResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VerifyTwoFactorResponse.Merge(m, src)
}
func (m *VerifyTwoFactorResponse) XXX_Size() int {
	return xxx_messageInfo_VerifyTwoFactorResponse.Size(m)
}
func (m *VerifyTwoFactorResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_VerifyTwoFactorResponse.DiscardUnknown(m)
}

var xxx_messageInfo_VerifyTwoFactorResponse proto.InternalMessageInfo

func (m *VerifyTwoFactorResponse) GetTwoFactor() *TwoFactor {
	if m != nil {
		return m.TwoFactor
	}
	return nil
...
func init() {
	proto.RegisterEnum("kript.api.TwoFactorType", TwoFactorType_name, TwoFactorType_value)
	...
	proto.RegisterMapType((map[string]*TwoFactor)(nil), "kript.api.LoginUserResponse.TwoFactorInfo.OptionsEntry")
	...
	proto.RegisterType((*AddTwoFactorRequest)(nil), "kript.api.AddTwoFactorRequest")
	proto.RegisterType((*AddTwoFactorResponse)(nil), "kript.api.AddTwoFactorResponse")
	proto.RegisterType((*VerifyTwoFactorRequest)(nil), "kript.api.VerifyTwoFactorRequest")
	proto.RegisterType((*VerifyTwoFactorResponse)(nil), "kript.api.VerifyTwoFactorResponse")
}
...
var fileDescriptor_574df43e36ddeef5 = []byte{
	...
	,
}
...
type AccountServiceClient interface {
	...
	AddTwoFactor(ctx context.Context, in *AddTwoFactorRequest, opts ...grpc.CallOption) (*AddTwoFactorResponse, error)
...
func (c *accountServiceClient) AddTwoFactor(ctx context.Context, in *AddTwoFactorRequest, opts ...grpc.CallOption) (*AddTwoFactorResponse, error) {
	out := new(AddTwoFactorResponse)
	err := c.cc.Invoke(ctx, "/kript.api.AccountService/AddTwoFactor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountServiceClient) VerifyTwoFactor(ctx context.Context, in *VerifyTwoFactorRequest, opts ...grpc.CallOption) (*VerifyTwoFactorResponse, error) {
	out := new(VerifyTwoFactorResponse)
	err := c.cc.Invoke(ctx, "/kript.api.AccountService/VerifyTwoFactor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountServiceServer interface {
	...
	// Request to add the given two-factor destination and send a confirmation
	// code to the two-factor destination.
	AddTwoFactor(context.Context, *AddTwoFactorRequest) (*AddTwoFactorResponse, error)
	// Verify a two-factor destination.
...
func (*UnimplementedAccountServiceServer) AddTwoFactor(ctx context.Context, req *AddTwoFactorRequest) (*AddTwoFactorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddTwoFactor not implemented")
}
func (*UnimplementedAccountServiceServer) VerifyTwoFactor(ctx context.Context, req *VerifyTwoFactorRequest) (*VerifyTwoFactorResponse, error) {
...
func _AccountService_AddTwoFactor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddTwoFactorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).AddTwoFactor(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kript.api.AccountService/AddTwoFactor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).AddTwoFactor(ctx, req.(*AddTwoFactorRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AccountService_VerifyTwoFactor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyTwoFactorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).VerifyTwoFactor(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kript.api.AccountService/VerifyTwoFactor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).VerifyTwoFactor(ctx, req.(*VerifyTwoFactorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AccountService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddTwoFactor",
			Handler:    _AccountService_AddTwoFactor_Handler,
		},
		{
			MethodName: "VerifyTwoFactor",
			Handler:    _AccountService_VerifyTwoFactor_Handler,
		},
	},
