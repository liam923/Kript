...
func (m *PublicUser) GetPasswordSalt() string {
	if m != nil {
...
type PrivateUser struct {
	...
	PrivateKeyKeySalt string `protobuf:"bytes,4,opt,name=private_key_key_salt,json=privateKeyKeySalt,proto3" json:"private_key_key_salt,omitempty"`
...
func (m *PrivateUser) GetPrivateKeyKeySalt() string {
	if m != nil {
...
type UpdatePasswordRequest struct {
	...
	PrivateKeyKeySalt string `protobuf:"bytes,9,opt,name=private_key_key_salt,json=privateKeyKeySalt,proto3" json:"private_key_key_salt,omitempty"`
...
func (m *UpdatePasswordRequest) GetPrivateKeyKeySalt() string {
	if m != nil {
		return m.PrivateKeyKeySalt
	}
	return ""
...
type CreateAccountRequest struct {
	...
	// The salt used in generating the key for encrypting/decrypting the private key.
	PrivateKeyKeySalt string `protobuf:"bytes,10,opt,name=private_key_key_salt,json=privateKeyKeySalt,proto3" json:"private_key_key_salt,omitempty"`
	// The hash algorithm used to generate the key for encrypting/decrypting the private key.
...
func (m *CreateAccountRequest) GetPrivateKeyKeySalt() string {
	if m != nil {
		return m.PrivateKeyKeySalt
	}
	return ""
...
var fileDescriptor_574df43e36ddeef5 = []byte{
	...
	,
}
